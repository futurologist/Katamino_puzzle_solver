...
int main()
{
	...
	int set_of_Pieces[n_pieces][n_squares + 1][2] = { { {0, 0}, {1, 0}, {1, 1}, {1, 2}, {2, 1}, { 8, 1} },
													  { {0, 0}, {1, 0}, {2, 0}, {1, 1}, {2, 1}, { 5, 1} },
													  { {0, 0}, {1, 0}, {2, 0}, {2, 1}, {3, 1}, { 3, 1} },
													  { {0, 0}, {1, 0}, {2, 0}, {3, 0}, {2, 1}, { 2, 1} },
													  { {0, 0}, {1, 0}, {1, 1}, {1, 2}, {2, 2}, {10, 0} },
													  { {0, 0}, {1, 0}, {2, 0}, {0, 1}, {2, 1}, { 9, 0} },
													  { {0, 0}, {1, 0}, {2, 0}, {2, 1}, {2, 2}, { 7, 0} },
													  { {0, 0}, {1, 0}, {2, 0}, {1, 1}, {1, 2}, { 6, 0} },
													  { {0, 0}, {1, 0}, {1, 1}, {2, 1}, {2, 2}, { 4, 0} },
													  { {0, 0}, {1, 0}, {2, 0}, {3, 0}, {3, 1}, { 1, 0} }
													  };
